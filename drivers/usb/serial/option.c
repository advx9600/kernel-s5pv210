...
#define ATWIN_VENDOR_ID				0x1782
#define ATWIN_PRODUCT_ID			0x3D00 
...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(ZTE_VENDOR_ID, ZTE_PRODUCT_M305) },
...
//  	  .driver_info = (kernel_ulong_t)&four_g_w14_blacklist
	...
	{ USB_DEVICE(LONGCHEER_VENDOR_ID, 0x9e00)},	

	{ USB_DEVICE(ATWIN_VENDOR_ID, ATWIN_PRODUCT_ID)},
  	{USB_DEVICE(0x04cc,0x225c)},
